package cn.bughome.middleware.db.router.config;

import cn.bughome.middleware.db.router.DBRouterConfig;
import cn.bughome.middleware.db.router.DBRouterJoinPoint;
import cn.bughome.middleware.db.router.dynamic.DynamicDataSource;
import cn.bughome.middleware.db.router.dynamic.DynamicMyBatisPlusPlugin;
import cn.bughome.middleware.db.router.strategy.IDBRouterStrategy;
import cn.bughome.middleware.db.router.strategy.impl.DBRouterStrategyHashCode;
import cn.bughome.middleware.db.router.util.PropertyUtil;
import cn.bughome.middleware.db.router.util.StringUtils;
...
public class DataSourceAutoConfig implements EnvironmentAware {
    ...
    @Bean("dbRouterDynamicMybatisPlusPlugin")
    public Interceptor plugin() {
        return new DynamicMyBatisPlusPlugin();
    }
